...
export default function SideBanners() {
  return (
    <>
      <div className="  text-gray-400 font-thin font-mono fixed bottom-0 right-20  flex flex-col justify-center items-center invisible lg:visible">
        <div className="transform -rotate-90 w-0">
          serpent_eyesus@hotmail.com
        </div>
        <div className=" border-l-2  h-28 border-gray-400"></div>
      </div>
      <div className="flex  ">
